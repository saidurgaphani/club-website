...
import { Link as RouterLink, useLocation } from 'react-router-dom' // Ensure useLocation is imported
...
export function AnimeNavBar({ items, className, defaultActive = 'Home' }: NavBarProps) {
  ...
  // This effect updates the active tab when the route changes
  useEffect(() => {
  ...
  return (
    <motion.div
      ...
      animate={hideNavbar ? 'hidden' : hidden ? 'hidden' : 'visible'} // Conditionally hide navbar
